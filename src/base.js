...
module.exports = {
    ...
    rules: {
        ...
        '@typescript-eslint/require-await': [IS_PROD ? 2 : 0], // 不允许没有异步函数的异步函数await表达
        '@typescript-eslint/return-await': [IS_PROD ? 2 : 0, 'never'], // 禁用不必要的 return await
        ...
        'eol-last': [IS_PROD ? 2 : 0, 'never'], // 禁止文件末尾存在空行
        eqeqeq: [2], // 要求使用 === 和 !==
        ...
        'require-await': [2], // 不允许没有异步函数的异步函数await表达
